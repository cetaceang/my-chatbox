                        ...
                        data.users.forEach(user => {
                            ...
                            if (!user.profile.is_admin) {
                                actionButton = user.profile.is_banned
                                    ? `<button class="btn btn-sm btn-success unban-user-btn" data-user-id="${user.id}" data-username="${user.username}">解封</button>`
                                    : `<button class="btn btn-sm btn-warning ban-user-btn" data-user-id="${user.id}" data-username="${user.username}">封禁</button>`;
                            } else {
